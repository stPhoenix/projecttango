...
from pybb.account.views import SignupView, LoginView, LogoutView, DeleteView
from pybb.account.views import ConfirmEmailView
from pybb.account.views import ChangePasswordView, PasswordResetView, PasswordResetTokenView
from pybb.account.views import SettingsView
