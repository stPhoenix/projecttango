...
PYBB_DEFAULT_TIME_ZONE = getattr(settings, 'PYBB_DEFAULT_TIME_ZONE', 2)
...
PYBB_ATTACHMENT_SIZE_LIMIT = getattr(settings, 'PYBB_ATTACHMENT_SIZE_LIMIT', 2048 * 2048)
...
PYBB_DEFAULT_TITLE = getattr(settings, 'PYBB_DEFAULT_TITLE', 'Projecttango - Forum. Last news discussion and tips related to the IT field')
...
PYBB_NICE_URL = getattr(settings, 'PYBB_NICE_URL', True)
...
PYBB_TEMPLATE = getattr(settings, 'PYBB_TEMPLATE', "forum_template.html")
...
PYBB_DEFAULT_AUTOSUBSCRIBE = getattr(settings, 'PYBB_DEFAULT_AUTOSUBSCRIBE', False)
...
PYBB_DISABLE_NOTIFICATIONS = getattr(settings, 'PYBB_DISABLE_NOTIFICATIONS', True)
